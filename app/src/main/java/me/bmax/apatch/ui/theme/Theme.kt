...
fun APatchTheme(
    ...
    // NorPatch: default accent theme is the soft "norpatch" palette.
    var customColorScheme by remember { mutableStateOf(prefs.getString("custom_color", "norpatch")) }
    ...
    if (refreshThemeObserver == true) {
        ...
        customColorScheme = prefs.getString("custom_color", "norpatch")
    ...
    val colorScheme = if (!dynamicColor) {
        if (darkTheme) {
            when (customColorScheme) {
                ...
                "norpatch" -> DarkNorPatchTheme
                else -> DarkNorPatchTheme
            }
        } else {
            when (customColorScheme) {
                ...
                "norpatch" -> LightNorPatchTheme
                else -> LightNorPatchTheme
            }
        }
    } else {
        when {
